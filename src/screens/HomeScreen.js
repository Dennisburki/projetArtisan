...
const HomeScreen = () => {
  return (
    <View style={{flex:1}}>
      ...
      <Text style={{marginHorizontal:20, textAlign:'justify', fontSize:20, marginVertical:15}}>Implantée au coeur du Havre depuis 1926, notre entreprise familiale propose différents services afin de répondre à vos besoins.</Text>
